...
public class JobDashboard extends JFrame {
	...
	public JobDashboard() {
		...
		setResizable(false);
		setTitle("Job Management Dashboard");
		...
		JLabel lblTitle = new JLabel("Job Management Dashboard");
		lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 38));
		lblTitle.setBounds(200, 25, 600, 60);
		...
		// Subtitle
		JLabel subtitleLabel = new JLabel("Manage job postings and assignments");
		subtitleLabel.setFont(new Font("Segoe UI", Font.PLAIN, 18));
		subtitleLabel.setBounds(200, 95, 600, 30);
		...
		findJobButton.setFont(new Font("Segoe UI", Font.BOLD, 22));
		findJobButton.setBounds(540, 300, 320, 90);
		styleButton(findJobButton, findColor, lightText, 20);
	...
	public static void main(String[] args) {
		SwingUtilities.invokeLater(() -> new JobDashboard());
	}
}